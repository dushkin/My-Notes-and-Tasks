  ...
  server: {
    ...
    headers: {
      'Content-Security-Policy': `
       ...
       connect-src 'self' http://localhost:5001 ws://localhost:5001 wss://my-notes-and-tasks-backend-dev.onrender.com wss://my-notes-and-tasks-backend.onrender.com https://my-notes-and-tasks-backend-dev.onrender.com https://my-notes-and-tasks-backend.onrender.com https://checkout.paddle.com https://checkout-service.paddle.com https://sandbox-checkout-service.paddle.com https://cdn.paddle.com https://sandbox-cdn.paddle.com http://cdn.jsdelivr.net https://cdn.jsdelivr.net https://play.google.com https://www.google-analytics.com https://analytics.google.com https://www.googletagmanager.com https://connect.facebook.net;
