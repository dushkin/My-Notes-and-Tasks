...
const LoadingButton = ({
  ...
  const variantClasses = {
    ...
    "danger-ghost": "bg-transparent text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/40 focus:ring-red-500",
  };
  const spinnerSize = {
    small: "w-3 h-3",
    default: "w-4 h-4",
  ...
  const finalClassName = `${baseClasses} ${sizeClasses[size]} ${variantClasses[variant] || variantClasses.primary} ${className}`;
