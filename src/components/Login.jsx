...
// If you use React Router, you'd import useNavigate here
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.token) {
        ...
        if (onLoginSuccess) {
          onLoginSuccess(data.user); // Notify App.jsx about successful login
        }
        // navigate('/app'); // Or your main app route if using React Router
      } else {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-zinc-100 dark:bg-zinc-900">
      <div className="p-8 bg-white dark:bg-zinc-800 rounded-lg shadow-xl w-full max-w-md">
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full px-4 py-2.5 border border-zinc-300 dark:border-zinc-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-zinc-700 text-zinc-900 dark:text-white"
              required
        ...
        {/* You can add a link to a registration page here if you build one */}
